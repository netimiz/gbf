<div class="col-sm-6 col-lg-6">
  <div class="card">
    <div class="card-body">
        ...
        <!--Form elemanları-->
        <form action="<?php echo base_url("tip/update/$item->id"); ?>" method="post">
            <div class="mb-3">
              <label class="form-label">Tip/Tür Adı
              ...
              <input type="text" class="form-control <?php if(isset($form_error)){ echo "is-invalid ";} ?>"
                name="title" placeholder="Tip Adı" value="<?php echo $item->title; ?>">
