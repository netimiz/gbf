        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="d-flex py-1 align-items-center">
                <div class="flex-fill">
                  <div class="font-weight-medium"><?php echo $item->urun_kodu; ?></div>
                  <div class="text-muted"><?php echo $item->cas_no; ?></div>
                </div>
              </div>
            </td>
            <td>
              <div class="d-flex py-1 align-items-center">
                <div class="flex-fill">
                  <div class="font-weight-medium"><?php echo $item->createdAt; ?></div>
                  <div class="text-muted"><?php echo $item->updateAt; ?></div>
                </div>
              </div>
            </td>
            <td>
