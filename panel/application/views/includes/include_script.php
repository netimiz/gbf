...
<!-- Libs JS -->
<script src="<?php echo base_url("assets/ui_assets"); ?>/dist/libs/apexcharts/dist/apexcharts.min.js?1620070918"> </script>
...
<!-- Tabler Core -->
<script src="<?php echo base_url("assets/ui_assets"); ?>/dist/js/tabler.min.js?1620070918"></script>
//revenue kısmı
<script>
  // @formatter:off
  document.addEventListener("DOMContentLoaded", function () {
    window.ApexCharts && (new ApexCharts(document.getElementById('chartz'), {
      chart: {
        type: "area",
        fontFamily: 'inherit',
        height: 40.0,
